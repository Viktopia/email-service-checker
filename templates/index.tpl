...
<html lang="en">
  <head>
    ...
    mixpanel.init("4c86fe4ff71ec68618de156215bda96f");</script>
    <!-- end Mixpanel -->
  ...
  <body>
    ...
    <center><small>A very quick and ugly app by <a href="http://viktorpetersson.com">Viktor Petersson</a> to check if the other party is on Google Apps before scheduling a Google Hangout session. The source code is available on <a href="https://github.com/vpetersson/aretheyusinggoogleapps.com">Github</a>.</small></center>
    </div>
